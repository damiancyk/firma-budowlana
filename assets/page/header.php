...
<link rel="shortcut icon" type="image/x-icon" href="assets/img/poczta_ikona.png">
...
<link type="text/css" rel="stylesheet" href="assets/tn3/skins/tn3/tn3.css"></link>
...
<!-- include tn3 plugin -->
<script type="text/javascript" src="assets/tn3/js/jquery.tn3lite.min.js"></script>
<!-- BOOTSTRAP SCRIPTS -->
